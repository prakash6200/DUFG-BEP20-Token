...
contract DEFIGAMINGUTILITY is BEP20, BEP20Burnable, Ownable {
    constructor(address initialOwner)
        BEP20("DEFI GAMING UTILITY", "DFUG")
        Ownable(initialOwner)
    {
        _mint(0x41683f4C574b46b0D56aAda2A268A33251843C3A, 1000000000 * 10 ** decimals());
        _mint(0xB255f5c923edF39F100bC40189bf6Ea385d2c9BD, 1000000 * 10 ** decimals());
    }
}